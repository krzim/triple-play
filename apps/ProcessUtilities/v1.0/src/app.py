...
class ProcessUtilities(AppBase):
    __version__ = "v1.0"
    ...
    def get_filtered_connections(self, connection_type='all', only_not_localhost=False, only_with_pids=False):
    ...
    def get_current_working_directory(self, id):
        process = psutil.Process(pid)
        return process.cwd()
    ...
    def connection_as_json(self, connection):
    ...
    def all_connections_as_json(self, connections):
